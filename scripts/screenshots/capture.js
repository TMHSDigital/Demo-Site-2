/**
 * Capture README screenshots of the SyncFlow AI site.
 *
...
const SITE_URL = process.env.SITE_URL || 'https://tmhsdigital.github.io/syncflow-frontend-demo/';
...
/** Scroll the page top-to-bottom so IntersectionObserver reveals fire. */
...
(async () => {
  ...
  await shootElement(page, '#results', 'testimonials.png');
  await shootElement(page, '#pricing', 'pricing.png');
  await page.close();
